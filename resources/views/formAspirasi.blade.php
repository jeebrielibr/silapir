...
<body>
  ...
  <!-- FAQ Section -->
  <!-- FAQ Section -->
  <section class="py-5" style="background: linear-gradient(#2c3e50,); color: #fff;">
    <div class="container">
          ...
          <div class="bg-white text-dark rounded-4 shadow p-4">
            ...
            <div class="accordion accordion-flush" id="faqAccordion">
              <div class="accordion-item mb-2 border rounded">
                ...
                <div id="faq1" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                  <div class="accordion-body">Ya, semua laporan yang masuk bersifat rahasia dan hanya dapat diakses oleh
                    pihak berwenang.</div>
                </div>
              </div>
              <div class="accordion-item mb-2 border rounded">
                ...
                <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                  <div class="accordion-body">Kamu bisa melaporkan langsung di laporan aspirasi.</div>
                </div>
              </div>
              <div class="accordion-item mb-2 border rounded">
                <h2 class="accordion-header">
                ...
                <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                  <div class="accordion-body">Paling lambat dalam 3 hari kerja, laporan akan direspon oleh pihak kampus.
                  </div>
                </div>
              </div>
              <div class="accordion-item mb-2 border rounded">
                ...
                <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                  <div class="accordion-body">Ya, kamu dapat memilih untuk anonim saat mengisi form, namun akan lebih
            ...
            <div class="text-center mt-4">
              <p class="mb-0 text-secondary">Masih punya pertanyaan? <a href="kontak"
                  class="text-decoration-none text-primary fw-semibold">Hubungi kami langsung</a>.</p>
            </div>
          </div>
        </div>
      </div>
