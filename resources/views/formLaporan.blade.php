...
<body>
    ...
    <div class="form-container mt-5">
        <h2>Laporan</h2>
        <p class="keterangan-form">Form ini bertujuan untuk menampung laporan mahasiswa terkait permasalahan fasilitas,
            layanan, atau lingkungan kampus agar dapat segera ditindaklanjuti.</p>
        @if ($errors->any())
                            ...
                            <div class="accordion-item mb-2 border rounded">
                                ...
                                <div id="faq4" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">Ya, kamu dapat memilih untuk anonim saat mengisi form,
                                        namun akan lebih baik jika identitas disertakan untuk verifikasi.</div>
                                </div>
                            </div>
                        </div>
